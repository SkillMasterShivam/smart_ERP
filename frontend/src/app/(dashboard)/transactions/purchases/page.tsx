        ...
        return (
          <div className="text-right">
            <Button variant="ghost" size="sm" asChild>
              <Link href={`/transactions/purchases/${row.original.id}`}>
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Purchase Vouchers</h1>
          <p className="text-sm text-gray-500">Manage inward supply and inventory purchases.</p>
        </div>
        <Button asChild>
      ...
      <div className="flex items-center max-w-md">
        <div className="relative w-full">
          ...
          <Input
            type="search"
            placeholder="Search by voucher or ref number..."
            className="pl-8"
            value={searchTerm}
